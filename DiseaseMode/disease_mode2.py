...
class DiseaseModeGenerator(PrimeKG):
    ...
    def generate_symptoms(self, output_dir=None, runs=5):
        """
        ...
        if output_dir is None:
            output_dir = os.path.expanduser('home/lasa14/scratch-llm/results/disease_mode/')
        ...
        # Save results
        rag_results_file = os.path.join(output_dir, f'{self.dataset_name}_rag_results.json')
        with open(rag_results_file, 'w') as f:
           json.dump(rag_results, f, indent=2)
        print(f"✓ RAG results saved to: {rag_results_file}")

        no_rag_results_file = os.path.join(output_dir, f'{self.dataset_name}_no_rag_results.json')
    ...
    def run_disease_mode(self, dataset_file, output_dir=None, runs=5):
        """
        ...
        try:
            ...
            with connection_pool.session_context('root', 'nebula') as session:
                ...
                # Generate symptoms
                rag_results, no_rag_results = self.generate_symptoms(output_dir, runs)
